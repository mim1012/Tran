    ...
    <div className="flex-1 flex flex-col">
      ...
      <div className="flex-1 p-4 sm:p-6 overflow-y-auto">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 mb-5 sm:mb-6">
          <div>
            <h2 className="text-base sm:text-lg font-bold text-gray-900 mb-0.5">발주 관리</h2>
            <p className="text-xs sm:text-[13px] text-gray-500">발주 등록, 조회 및 상태 관리</p>
          </div>
          <button className="btn-primary self-start"><i className="fas fa-plus" /> 신규 발주</button>
        </div>
                  ...
                  <tr key={order.orderId}>
                    ...
                    <td className="table-cell">
                      <div className="flex gap-1">
                        ...
                        <button className="w-7 h-7 rounded-lg flex items-center justify-center text-gray-400 hover:bg-blue-50 hover:text-primary transition-colors"><i className="fas fa-ellipsis-v text-xs" /></button>
                      </div>
                    </td>
                  </tr>
                ))}
